...
export const PUBLIC =
  typeof process.env.PUBLIC === 'string'
...
export const GRAPHQL_SUBSCRIPTIONS_ENDPOINT =
  process.env.GRAPHQL_SUBSCRIPTIONS_ENDPOINT;
export const GRAPHQL_ENDPOINT = process.env.GRAPHQL_ENDPOINT;
export const APOLLO_QUERY_BATCH_INTERVAL =
  process.env.APOLLO_QUERY_BATCH_INTERVAL;
export const PERSISTED_QUERIES = process.env.PERSISTED_QUERIES; // used only on client-side

export const ENABLE_RECAPTCHA =
  typeof process.env.ENABLE_RECAPTCHA === 'string'
    ? process.env.ENABLE_RECAPTCHA === 'true'
    : process.env.ENABLE_RECAPTCHA; // will be string on server-side
...
export const PATH_EMAIL_VERIFICATION_SUCCESS =
  process.env.PATH_EMAIL_VERIFICATION_SUCCESS;
export const PATH_PASSWORD_RESET_SUCCESS =
  process.env.PATH_PASSWORD_RESET_SUCCESS;
...
export const PATH_SETTINGS_CHANGE_PASSWORD =
  process.env.PATH_SETTINGS_CHANGE_PASSWORD;
export const PATH_SETTINGS_BUSINESS_DETAILS =
  process.env.PATH_SETTINGS_BUSINESS_DETAILS;
export const PATH_SETTINGS_CHANGE_EMAIL = process.env.PATH_SETTINGS_CHANGE_EMAIL;
export const PATH_SETTINGS_BUSINESS_USERS =
  process.env.PATH_SETTINGS_BUSINESS_USERS;
export const PATH_SETTINGS_BUSINESS_USER =
  process.env.PATH_SETTINGS_BUSINESS_USER;
export const PATH_SETTINGS_BUSINESS_USER_PARAM =
  process.env.PATH_SETTINGS_BUSINESS_USER_PARAM;
...
export const SECURE =
  typeof process.env.SECURE === 'string'
    ? process.env.SECURE === 'true'
    : process.env.SECURE; // will be string on server-side
