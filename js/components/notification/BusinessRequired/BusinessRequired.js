...
import { APP_NAME, PATH_SETTINGS_BASE, PATH_SETTINGS_BUSINESS_DETAILS } from 'vars';
...
class BusinessRequired extends React.Component {
  render() {
    ...
    const values = {
      ...
      link: (
        <Link className={style.businessLink} to={PATH_SETTINGS_BASE + '/' + PATH_SETTINGS_BUSINESS_DETAILS}>
