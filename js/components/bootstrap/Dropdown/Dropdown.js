...
class Dropdown extends React.Component {
  ...
  render() {
    ...
    const classes = {
      [getLocalCSSClassName(style, bsClass)]: true,
      [getLocalCSSClassName(style, 'open')]: open,
      [getLocalCSSClassName(style, 'disabled')]: disabled,
    };

    if (dropup) {
      classes[getLocalCSSClassName(style, bsClass)] = false;
      classes[getLocalCSSClassName(style, dropup)] = true;
    }
