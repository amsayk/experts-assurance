...
import { sortDocs } from 'redux/reducers/docSearch/actions';
  ...
  render() {
    ...
    return (
      <div className={style.listHeader}>
        ...
        <div
          onClick={this.onSortByClient}
          className={cx(
            style.listHeaderItemClient,
            key === 'client.name' && style.sorting,
          )}
        >
          <div className={style.wrapper}>
            <div className={style.innerWrapper}>
        ...
        <div
          onClick={this.onSortByAgent}
          className={cx(
            style.listHeaderItemAgent,
            key === 'agent.name' && style.sorting,
          )}
        >
          <div className={style.wrapper}>
            <div className={style.innerWrapper}>
        ...
        <div
          onClick={this.onSortByManufacturer}
          className={cx(
            style.listHeaderItemVehicle,
            key === 'vehicle.manufacturer' && style.sorting,
          )}
        >
          <div className={style.wrapper}>
            <div className={style.innerWrapper}>
              <div className={style.item}>
                <div className={cx(style.text)}>Fabricant</div>
        ...
        <div
          onClick={this.onSortByModel}
          className={cx(
            style.listHeaderItemVehicle,
            key === 'vehicle.model' && style.sorting,
          )}
        >
          <div className={style.wrapper}>
            <div className={style.innerWrapper}>
        ...
        <div
          onClick={this.onSortByPlateNumber}
          className={cx(
            style.listHeaderItemVehicle,
            key === 'vehicle.plateNumber' && style.sorting,
          )}
        >
          <div className={style.wrapper}>
            <div className={style.innerWrapper}>
