      ...
      <div className={style.listHeader}>
        ...
        <div className={style.listHeaderItemClient}>
          <div className={style.wrapper}>
            <div className={style.innerWrapper}>
              <div className={style.item}>
                <div className={cx(style.text)}>Client</div>
              </div>
            </div>
          </div>
        </div>

        <div className={style.listHeaderItemInsurer}>
          <div className={style.wrapper}>
            <div className={style.innerWrapper}>
              <div className={style.item}>
        ...
        <div className={style.listHeaderItemVehicle}>
          <div className={style.wrapper}>
            <div className={style.innerWrapper}>
              <div className={style.item}>
                <div className={cx(style.text)}>Voiture (Modèle, Matricule)</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div onClick={this.onSortByDate} className={cx(style.listHeaderItemDate, key === 'date' && style.sorting)}>
          <div className={style.wrapper}>
            <div className={style.innerWrapper}>
              <div className={style.item}>
                <div className={style.text}>Dernière mise à jour</div>
