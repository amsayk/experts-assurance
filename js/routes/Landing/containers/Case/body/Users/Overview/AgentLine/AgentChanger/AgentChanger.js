...
import createUserPicker from './PickAgent';

const PickAgent = createUserPicker(Role_ADMINISTRATORS, Role_AGENTS);

class AgentChanger extends React.Component {
  state ={
    open : false,
    queryString : '',
    selectedUserId : null,
