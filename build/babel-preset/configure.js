...
module.exports = function(options) {
  ...
  let presetSets = [
    [
      ...
      options.autoImport
        ? require.resolve('babel-preset-fbjs/plugins/auto-importer')
        : null,
      options.rewriteModules
        ? [
            require.resolve('babel-preset-fbjs/plugins/rewrite-modules'),
            options.rewriteModules || {},
          ]
        : null,
    ],
    [
      options.inlineRequires
        ? require.resolve('babel-preset-fbjs/plugins/inline-requires')
        : null,
      options.stripDEV
        ? require.resolve('babel-preset-fbjs/plugins/dev-expression')
        : null,
    ],
  ];
  ...
  if (options.target === 'flow') {
    presetSets[0].push(
      require.resolve('babel-preset-fbjs/plugins/dev-declaration'),
    );
  }
  ...
  if (options.target === 'js') {
    presetSets[0] = presetSets[0].concat([
      ...
      options.objectAssign
        ? require.resolve('babel-preset-fbjs/plugins/object-assign')
        : null,
    ]);
  }
